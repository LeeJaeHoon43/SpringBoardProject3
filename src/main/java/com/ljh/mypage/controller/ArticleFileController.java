...
import com.ljh.mypage.commons.utils.MediaUtils;
import com.ljh.mypage.commons.utils.UploadFileUtils;
import com.ljh.mypage.service.ArticleFileService;
...
public class ArticleFileController {
	...
	public ResponseEntity<List<String>> fileList(@PathVariable("article_no") Integer article_no) throws Exception { 
		...
		try { 
			...
			e.printStackTrace(); entity = new ResponseEntity<List<String>>(HttpStatus.BAD_REQUEST); 
		} 
		return entity; 
	}
